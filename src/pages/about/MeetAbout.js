import beeSvg from '../../assets/svg/background/bee.svg'

const MeetAbout = (props)=>{
    return (
        <div className="w-auto bg-bee-blue p-8 md:p-16 flex-col">
            <div className="flex text-white flex-col md:flex-row-reverse gap-16">
                <div className='flex  flex-1 items-center justify-center'>
                    <img src={beeSvg} alt="" className='m-8 h-64 md:h-auto' />
                </div>
                <div className='flex flex-1 justify-center flex-col'>
                    <div className='text-2xl md:text-3xl font-semibold'>Meet</div>
                    <div className='text-5xl md:text-5xl font-bold'>BEEKABOO</div>
