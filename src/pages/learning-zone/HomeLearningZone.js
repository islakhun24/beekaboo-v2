import bgyellow from "../../assets/background/bg-yellow.svg";
import PencilSvg from "../../assets/svg/undraw/pencil.svg"

const HomeLearningZone = (props)=>{
    return (
...
export default HomeLearningZone;